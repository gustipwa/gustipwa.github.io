...
<center>
	...
	<br><img width="550" height="250"  src="https://i.ytimg.com/vi/zlDiX-378uM/maxresdefault.jpg"/>
		<br>
<br><font color="white" >Scampage Apple 3.0.0 (New)</font><br>
<br><font color="white">Harga     : Rp.80.000,00</font><br>
	<br><font color="white">========================[<button class="button button3" onclick="window.location.href='apple.htm'">-Back-</button>]========================</font>
	<br>
